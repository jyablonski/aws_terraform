...
# resource "aws_route53_record" "jacobs_opensearch_route53_record_api" {
#   zone_id = aws_route53_zone.jacobs_website_zone.zone_id
#   name    = "opensearch.${local.website_domain}"
#   type    = "CNAME"
#   ttl     = 300
#   records = ["${aws_elasticsearch_domain.jacobs_opensearch_cluster.endpoint}"]
# }
...
#   destination_arn = "arn:aws:lambda:us-east-1:288364792694:function:LogsToElasticsearch_jacobs-opensearch-cluster"
# }