...
#   description = "Allow Jacob's Traffic to RDS"
#   vpc_id      = aws_vpc.jacobs_vpc_tf.id # needs to get changed
...
#   ingress {
#     description      = "Inbound rules for RDS DB"
#     from_port        = 3306
#     to_port          = 3306
#     protocol         = "tcp"
#     cidr_blocks      = [aws_vpc.jacobs_vpc_tf.cidr_block]
#     ipv6_cidr_blocks = [aws_vpc.jacobs_vpc_tf.ipv6_cidr_block]
#   }
